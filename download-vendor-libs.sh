...
curl -o src/main/resources/static/vendor/chartjs/chart.js https://cdn.jsdelivr.net/npm/chart.js
...
curl -o src/main/resources/static/vendor/chartjs/chartjs-plugin-zoom.js https://cdn.jsdelivr.net/npm/chartjs-plugin-zoom
...
curl -o src/main/resources/static/vendor/flatpickr/flatpickr.js https://cdn.jsdelivr.net/npm/flatpickr
